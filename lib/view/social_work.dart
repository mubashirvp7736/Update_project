...
class SocialCategorie extends StatefulWidget {
  final String? selectedJobCategory;
  const SocialCategorie({super.key, this.selectedJobCategory});
  @override
  // ignore: library_private_types_in_public_api
  _ListStudentState createState() => _ListStudentState();
}

class _ListStudentState extends State<SocialCategorie> {
  String ? image;
  @override
  void initState() {
    super.initState(); 
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('SocialWorkers'),
          centerTitle: true,
          actions: [
